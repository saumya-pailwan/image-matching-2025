...
def resize_images(images, shapes, max_size = None):

    is_none = max_size is None
    ...
    ret = images, max_size if is_none else images

    return ret

    

def pad_images(images, shapes, max_size = None):
...
def preprocess_training_data(read_dir, write_dir, collate_fcn = "resizing"):
    ...
    normalized_train_images, max_size = collate_fcns[collate_fcn](normalized_train_images)
    normalized_valid_images = collate_fcns[collate_fcn](normalized_valid_images, max_size)
    ...
    np.savez(join(write_dataset_dir, "train.npz"), train = normalized_train_images, valid = normalized_valid_images)
...
def preprocess_data(data_dir):
    ...
    preprocess_training_data(train_dir, preocessed_dir)
